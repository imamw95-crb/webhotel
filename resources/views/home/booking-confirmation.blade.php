    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
            ...
            <div class="p-6 space-y-4">
                @forelse($bankAccounts as $bank)
                    <div class="border border-gray-200 rounded-xl p-5 hover:border-blue-200 transition">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <p class="font-mono font-bold text-lg text-navy-800 tracking-wider">{{ $bank['account'] }}</p>
                            </div>
                        </div>
                        <div class="mt-2">
            ...
            <div class="p-6">
                ...
                @elseif($phone)
                    <div class="mt-6 p-5 bg-gray-50 border border-gray-200 rounded-xl">
                        <p class="font-semibold text-navy-800 mb-2">Call Receptionist</p>
                        <p class="text-sm text-gray-600 mb-3">Call our receptionist to confirm your payment.</p>
                        <a href="tel:{{ $phone }}"
                           class="inline-flex items-center gap-2 bg-navy-800 hover:bg-navy-900 text-white font-semibold px-6 py-3 rounded-xl transition">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="{{ route('booking.track') }}?booking_code={{ $booking->booking_code }}"
               class="inline-flex items-center justify-center gap-2 bg-navy-800 hover:bg-navy-900 text-white font-semibold px-6 py-3 rounded-xl transition">
        ...
        <div class="text-center mt-8">
            <p class="text-xs text-gray-400">
                Check-in time: 14:00 &middot; Check-out time: 12:00
            </p>
        </div>
    </div>
</section>
